...
public static class SettingsSearchIndex
{
    ...
    [
        ...
        Create(
            3,
            "静置层",
            "始终显示的基础层：信息密度、内容排列与对齐",
            ["静置", "常驻", "rest", "信息密度", "density", "精简", "均衡", "排列", "布局", "layout", "对齐", "标题", "歌手", "artist", "内容排列"]),
        Create(
            4,
            "悬停层",
            "鼠标移入媒体栏时出现的快捷控制",
        ...
        Create(
            ...
            "静置层组件",
            "叠加在静置层右侧的频谱与性能组件",
            ["频谱", "spectrum", "均衡", "柱", "柱数", "刷新率", "灵敏度", "性能", "performance", "内存", "cpu", "gpu", "指标", "任务管理器", "柱子数量", "刷新速度", "跳动幅度"]),
        Create(
            SettingsPageKey.MediaAndNotifications,
            3,
            "曲目切换通知",
