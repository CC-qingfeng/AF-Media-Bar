...
public partial class InteractionPage : INavigableView<InteractionViewModel>
{
    ...
    private async void ResetButton_Click(object sender, RoutedEventArgs e) { if (await SettingsResetDialog.ConfirmAsync("Common.Page.Interaction")) ViewModel.ResetInteraction(); }
}
